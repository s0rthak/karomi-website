...
define('karomi-ember/components/about-page', ['exports', 'ember', 'config/environment'], function (exports, _ember, _configEnvironment) {
  exports['default'] = _ember['default'].Component.extend({
    rootURL: _configEnvironment['default'].rootURL
  });
});
define('karomi-ember/components/collection-page', ['exports', 'ember', 'config/environment'], function (exports, _ember, _configEnvironment) {
  exports['default'] = _ember['default'].Component.extend({
    rootURL: _configEnvironment['default'].rootURL,
    actions: {
...
define('karomi-ember/components/contact-page', ['exports', 'ember', 'config/environment'], function (exports, _ember, _configEnvironment) {
  exports['default'] = _ember['default'].Component.extend({
    rootURL: _configEnvironment['default'].rootURL
...
define('karomi-ember/components/karomi-header', ['exports', 'ember', 'config/environment'], function (exports, _ember, _configEnvironment) {
  exports['default'] = _ember['default'].Component.extend({
    rootURL: _configEnvironment['default'].rootURL,
    didInsertElement: function didInsertElement() {
...
if (!runningTests) {
  require("karomi-ember/app")["default"].create({"name":"karomi-ember","version":"0.0.0+6ee9dd7d"});
}
